...
public class IDutil {
    ...
    private static IDutil me = new IDutil();
    ...
    /**
     * 获取MD5之后的IDutil string
     *
     * @return IDutil md5 string
     */
    public String getIDutilHashString() {
        return hashString(getIDutil());
    }
     ...
     * @return byte[16]
     */
    public byte[] getIDutilHash() {
        return hash(getIDutil());
    }
